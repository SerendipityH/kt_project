...
public class TokenController {
     ...
     * 
     * @ResponseBody public String getUserByToken(@PathVariable String token, String callback) {
     * E3Result result = tokenService.getUserByToken(token); // 响应结果之前，判断是否为jsonp请求 if
