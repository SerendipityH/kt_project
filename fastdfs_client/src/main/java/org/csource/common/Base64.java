...
/**
 * Freeware from: Roedy Green Canadian Mind Products #327 - 964 Heywood Avenue Victoria, BC Canada
 * V8V 2Y5 tel:(250) 361-9093 mailto:roedy@mindprod.com
 */
...
public class Base64 {
  ...
  public static void main(String[] args) {
    ...
    if (debug) {
      ...
      /*
       * byte[] a = { (byte)0xfc, (byte)0x0f, (byte)0xc0}; byte[] b = { (byte)0x03, (byte)0xf0,
       * (byte)0x3f}; byte[] c = { (byte)0x00, (byte)0x00, (byte)0x00}; byte[] d = { (byte)0xff,
       * (byte)0xff, (byte)0xff}; byte[] e = { (byte)0xfc, (byte)0x0f, (byte)0xc0, (byte)1}; byte[]
       * f = { (byte)0xfc, (byte)0x0f, (byte)0xc0, (byte)1, (byte)2}; byte[] g = { (byte)0xfc,
       * (byte)0x0f, (byte)0xc0, (byte)1, (byte)2, (byte)3}; byte[] h = "AAAAAAAAAAB".getBytes();
       * 
       * 
       * 
       * show(a); show(b); show(c); show(d); show(e); show(f); show(g); show(h); Base64 b64 = new
       * Base64(); show(b64.decode(b64.encode(a))); show(b64.decode(b64.encode(b)));
       * show(b64.decode(b64.encode(c))); show(b64.decode(b64.encode(d)));
       * show(b64.decode(b64.encode(e))); show(b64.decode(b64.encode(f)));
       * show(b64.decode(b64.encode(g))); show(b64.decode(b64.encode(h))); b64.setLineLength(8);
