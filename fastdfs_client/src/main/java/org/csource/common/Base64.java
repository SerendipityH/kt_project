...
public class Base64 {
    ...
    public static void main(String[] args) {
        ...
        if (debug) {
             ...
             * (byte)0xf0, (byte)0x3f}; byte[] c = { (byte)0x00, (byte)0x00, (byte)0x00}; byte[] d =
             * { (byte)0xff, (byte)0xff, (byte)0xff}; byte[] e = { (byte)0xfc, (byte)0x0f,
             * (byte)0xc0, (byte)1}; byte[] f = { (byte)0xfc, (byte)0x0f, (byte)0xc0, (byte)1,
             * (byte)2}; byte[] g = { (byte)0xfc, (byte)0x0f, (byte)0xc0, (byte)1, (byte)2,
             * (byte)3}; byte[] h = "AAAAAAAAAAB".getBytes();
             * 
             * 
             * 
             * show(a); show(b); show(c); show(d); show(e); show(f); show(g); show(h); Base64 b64 =
             * new Base64(); show(b64.decode(b64.encode(a))); show(b64.decode(b64.encode(b)));
