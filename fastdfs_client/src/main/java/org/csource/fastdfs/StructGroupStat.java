...
public class StructGroupStat extends StructBase {
    ...
    public void setFields(byte[] bs, int offset) {
        ...
        this.currentWriteServer =
                intValue(bs, offset, fieldsArray[FIELD_INDEX_CURRENT_WRITE_SERVER]);
        ...
        this.currentTrunkFileId =
                intValue(bs, offset, fieldsArray[FIELD_INDEX_CURRENT_TRUNK_FILE_ID]);
    }
