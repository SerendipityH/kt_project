...
public class StorageClient1 extends StorageClient {
	 ...
	 * 
	 * @param file_id  the file id(including group name and filename)
	 * @param callback the callback object, will call callback.recv() when data
	 *                 arrive
	 * @return 0 success, return none zero errno if fail
	 */
	 ...
	 *                  overwrite all old metadata items</li>
	 *                  </ul>
	 *                  <ul>
	 *                  <li>ProtoCommon.STORAGE_SET_METADATA_FLAG_MERGE: merge,
	 *                  insert when the metadata item not exist, otherwise update
	 *                  it</li>
	 *                  </ul>
