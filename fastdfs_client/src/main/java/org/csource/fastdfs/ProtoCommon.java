...
public class ProtoCommon {
     ...
     * @return name value pair array
     */
    public static NameValuePair[] split_metadata(String meta_buff, String recordSeperator,
    ...
    public static String getToken(String remote_filename, int ts, String secret_key)
        ...
        System.arraycopy(bsTimestamp, 0, buff, bsFilename.length + bsKey.length,
                bsTimestamp.length);
     ...
     * @param ext_name the extension name of slave filename, null for same as the master extension
     *        name
     * @return slave filename string
     */
    public static String genSlaveFilename(String master_filename, String prefix_name,
            String ext_name) throws MyException {
        ...
        dotIndex = master_filename.indexOf('.',
                master_filename.length() - (FDFS_FILE_EXT_NAME_MAX_LEN + 1));
        if (ext_name != null) {
