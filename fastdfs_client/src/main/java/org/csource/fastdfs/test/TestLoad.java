    ...
    public static class Downloader {
        ...
        public int downloadFile(String file_id) throws Exception {
            ...
            try {
                ...
                if (errno != 0) {
                    System.out.println(
                            "Download file fail, file_id: " + file_id + ", error no: " + errno);
                }
                return errno;
            } catch (Exception ex) {
    ...
    public static class UploadThread extends Thread {
        ...
        public void run() {
            ...
            System.out.println("upload thread " + this.thread_index + " exit, total_upload_count: "
                    ...
                    + TestLoad.success_upload_count + ", total_download_count: "
                    + TestLoad.total_download_count + ", success_download_count: "
