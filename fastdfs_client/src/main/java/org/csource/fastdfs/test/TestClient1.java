...
public class TestClient1 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            /*
             * group_name = "group1"; file_id = client.upload_file1(group_name, file_buff, "txt",
             * meta_list);
             */
            if (file_id == null) {
                ...
                slave_file_id = client.upload_file1(master_file_id, prefix_name, file_buff,
                ...
                if (slave_file_id != null) {
                    ...
                    generated_slave_file_id = ProtoCommon.genSlaveFilename(master_file_id,
            ...
            if ((file_id = client.upload_file1(local_filename, null, meta_list)) != null) {
                ...
                errno = client.download_file1(file_id, 0, 100,
                        "c:\\" + file_id.replaceAll("/", "_"));
                if (errno == 0) {
                ...
                errno = client.download_file1(file_id,
                        new DownloadFileWriter("c:\\" + file_id.replaceAll("/", "-")));
                if (errno == 0) {
                    System.err.println("Download file success");
                } else {
                    System.err.println("Download file fail, error no: " + errno);
                ...
                prefix_name = "-part2";
                file_ext_name = null;
                slave_file_id = client.upload_file1(master_file_id, prefix_name, local_filename,
                        file_ext_name, meta_list);
                if (slave_file_id != null) {
                    System.err.println("slave file_id: " + slave_file_id);
                    System.err.println(client.get_file_info1(slave_file_id));
            ...
            file_id = client.upload_file1(null, f.length(),
