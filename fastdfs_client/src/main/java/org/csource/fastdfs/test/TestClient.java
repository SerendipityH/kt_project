...
public class TestClient {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            /*
             * storageServer = tracker.getStoreStorage(trackerServer); if (storageServer == null) {
            ...
            if (storageServers == null) {
                System.err.println(
                        "get store storage servers fail, error code: " + tracker.getErrorCode());
            } else {
            ...
            /*
             * group_name = ""; results = client.upload_file(group_name, file_buff, "txt",
             * meta_list);
             */
            if (results == null) {
                ...
                System.err.println(
                        "group_name: " + group_name + ", remote_filename: " + remote_filename);
                ...
                if (servers == null) {
                    System.err.println(
                            "get storage servers fail, error code: " + tracker.getErrorCode());
                } else {
                ...
                System.out.println("set_metadata time used: "
                ...
                System.out.println("download_file time used: "
                        + (System.currentTimeMillis() - startTime) + " ms");
                ...
                file_ext_name = "txt";
                startTime = System.currentTimeMillis();
                results = client.upload_file(group_name, master_filename, prefix_name, file_buff,
                        file_ext_name, meta_list);
                System.out.println("upload_file time used: "
                        + (System.currentTimeMillis() - startTime) + " ms");
                if (results != null) {
                    System.err.println("slave file group_name: " + results[0]
                            + ", remote_filename: " + results[1]);

                    generated_slave_filename = ProtoCommon.genSlaveFilename(master_filename,
                ...
                System.out.println("delete_file time used: "
                        + (System.currentTimeMillis() - startTime) + " ms");
                if (errno == 0) {
            ...
            if (results != null) {
                ...
                group_name = results[0];
                remote_filename = results[1];
                file_id = group_name + StorageClient1.SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR
                        + remote_filename;
                ...
                file_ext_name = null;
                startTime = System.currentTimeMillis();
                results = client.upload_file(group_name, master_filename, prefix_name,
                        local_filename, null, meta_list);
                System.out.println("upload_file time used: "
                        + (System.currentTimeMillis() - startTime) + " ms");
                if (results != null) {
                    System.err.println("slave file group_name: " + results[0]
            ...
            if (results != null) {
                ...
                System.out.println(
                        "group name: " + group_name + ", remote filename: " + remote_filename);
