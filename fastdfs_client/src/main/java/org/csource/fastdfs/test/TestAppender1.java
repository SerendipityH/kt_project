...
public class TestAppender1 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            System.out.println("upload_appender_file1 time used: "
                    + (System.currentTimeMillis() - startTime) + " ms");

            /*
             * group_name = ""; appender_file_id = client.upload_appender_file1(group_name,
            ...
            if (appender_file_id == null) {
                ...
                System.out.println("append_file time used: "
                        + (System.currentTimeMillis() - startTime) + " ms");
                if (errno == 0) {
                    System.err.println(client.get_file_info1(appender_file_id));
                } else {
            ...
            if (appender_file_id != null) {
                ...
                errno = client.modify_file1(appender_file_id, 0, f.length(),
                        new UploadLocalFileSender(local_filename));
                System.out.println("modify_file time used: "
                        + (System.currentTimeMillis() - startTime) + " ms");
                if (errno == 0) {
                    System.err.println(client.get_file_info1(appender_file_id));
                } else {
                ...
                System.out.println("truncate_file time used: "
                        + (System.currentTimeMillis() - startTime) + " ms");
                if (errno == 0) {
                    System.err.println(client.get_file_info1(appender_file_id));
                } else {
