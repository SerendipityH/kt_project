...
public class TestAppender {
	...
	public static void main(String args[]) {
		...
		try {
			...
			/*
			 * storageServer = tracker.getStoreStorage(trackerServer); if (storageServer ==
			 * null) { System.out.println("getStoreStorage fail, error code: " +
			 * tracker.getErrorCode()); return; }
			 */
			...
			/*
			 * group_name = ""; results = client.upload_appender_file(group_name, file_buff,
			 * "txt", meta_list);
			 */
			if (results == null) {
